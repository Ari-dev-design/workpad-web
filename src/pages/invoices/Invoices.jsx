...
import { Plus, Search, Trash2, FileText, Download, Edit } from "lucide-react";
...
export default function Invoices() {
  ...
  const loadData = async () => {
    ...
    const projectsMap = projectsData.reduce((acc, proj) => {
      acc[proj.id] = proj;
      return acc;
    }, {});
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {invoices.map((invoice) => (
          <div
            ...
            className="p-4 border-b border-gray-50 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-gray-50 transition-colors gap-4 sm:gap-0 cursor-pointer"
          ...
          >
            ...
            <div className="flex items-center justify-between w-full sm:w-auto sm:gap-6">
              ...
              >
                ...
                >
                  {invoice.status === "Pagado" ? "Pagada" : "Pendiente"}
                </span>
                ...
                {invoice.status === "Pagado" ? (
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      alert("No se puede descargar la factura porque aún no está pagada.");
                    }}
                    className="text-gray-300 hover:text-red-500 p-2 transition-colors cursor-not-allowed"

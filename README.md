...
*Nota: La estructura visual y los datos de la aplicación, dashboard del usuario.*

### Gestión de Clientes

![Clientes](./screenshots/clientes.png)
*Nota: La captura corresponde a la cartera de clientes de un usuario .*

### Generación de Facturas PDF

![Factura](./screenshots/facturas.png)
*Nota: Captura del apartado Facturas.*
...
| -------------------- | -------------------------------------------------------- |
| **PostgreSQL**       | Base de datos relacional real y completa (DB principal)  |
| **Supabase**         | Infraestructura de Backend as a Service (BaaS)           |
| **Supabase Auth**    | Gestión de usuarios y políticas de seguridad (RLS)       |
| **Supabase Storage** | Almacenamiento de archivos (logos y documentos)          |
...
│   │   ├── layout/         # Layout principal y navegación (Sidebar, etc.)
│   │   │   ├── Layout.jsx
│   │   │   ├── ProtectedRoute.jsx
│   │   │   └── Sidebar.jsx
│   │   └── pdf/            # Generador de Facturas (react-pdf)
│   │       └── InvoiceDocument.jsx
│   │
│   ├── context/            # Contextos de React (Autenticación Global)
│   │   └── AuthContext.jsx
│   │
│   ├── pages/              # Vistas principales organizadas por módulos
│   │   ├── auth/           # Pantallas de Login y Registro
│   │   │   ├── Login.jsx
│   │   │   └── Register.jsx
│   │   ├── clients/        # Formularios y listados de Clientes
│   │   │   ├── ClientForm.jsx
│   │   │   └── Clients.jsx
│   │   ├── dashboard/      # Panel de resumen estadístico principal
│   │   │   └── Dashboard.jsx
│   │   ├── invoices/       # Gestión y formulación de Facturas
│   │   │   ├── InvoiceForm.jsx
│   │   │   └── Invoices.jsx
...
│   │       └── Projects.jsx
│   │
│   ├── services/           # Lógica y llamadas a API con Supabase
│   │   └── api.js
│   │
│   ├── App.css             # Estilos globales auxiliares
│   ├── index.css           # Estilos principales iniciales y directivas de Tailwind
